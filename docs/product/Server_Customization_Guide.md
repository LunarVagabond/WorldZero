...
| `server` | `WZ_SERVER_ADDR`, `WZ_METRICS_ADDR`, `WZ_HEALTH_ADDR`, `WZ_LAYER_ENABLED`, `WZ_LAYER_POPULATION_THRESHOLD`, `WZ_PLUGINS_DIR`, `WZ_REALM_ID`, `WZ_REALM_LEASE_TTL_SECS` | `game.yaml` | `GameManifest` |
